...
?>
<?php
  $dash_block = module_invoke("block", 'block_view', 5);
  if(isset($dash_block['content'])){
    print render($dash_block['content']);
  }
?>
<br/>
...
<a class='campaign-edit' href="/node/<?php print $node->nid ?>/edit">Edit this Campaign</a>
