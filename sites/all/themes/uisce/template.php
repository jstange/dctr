...
function uisce_strip_render($obj){
 ...
 */
function uisce_preprocess_html(&$vars) {
$vars['rdf'] = new stdClass;
  ...
  if (theme_get_setting('uisce_localcss') == TRUE) {
  ...
  if (theme_get_setting('uisce_custom_css_location') == TRUE) {
    $path =  theme_get_setting('uisce_custom_css_path');
    if (file_exists($path)) {
      drupal_add_css("$path",
        array(
          'group' => CSS_THEME,
  ...
  // Add general JS.
  drupal_add_js(drupal_get_path('theme', 'uisce') . '/js/scripts.js',
    array(
      'group' => JS_THEME,
      'preprocess' => TRUE,
      'weight' => '9999',
  ...
  if (theme_get_setting('uisce_tertiarymenu') == TRUE) {
  ...
  if (theme_get_setting('uisce_themelogo') == TRUE) {
 ...
 */
function uisce_html_head_alter(&$head_elements) {
 ...
 */
function uisce_preprocess_username(&$vars) {
 ...
 */
function uisce_breadcrumb($vars) {
 ...
 */
function uisce_preprocess_page(&$vars, $hook) {
 ...
 */
function uisce_menu_local_tasks(&$vars) {
  $output = '';
 ...
 */
function uisce_preprocess_node(&$vars) {
...
function uisce_commerce_cart_empty_block() {
    return '';
}
function uisce_commerce_line_item_summary_link_info_alter(&$variables) {
  global $theme_path_real;
  $variables['view_cart']['title']=t('Begin Checkout');
  $variables['view_cart']['html']=true;
  $variables['checkout']['title']=t('Check Out');
  $variables['checkout']['html']=true;  
}

/**
 * Implements hook_page_alter().
 */
function uisce_page_alter($page) {
  ...
  if (theme_get_setting('uisce_viewport') == FALSE) {
